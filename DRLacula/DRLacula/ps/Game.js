...
(function(exports) {
  ...
  var Engine_Effects = PS["Engine.Effects"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];     
  var asciiArtTitle = [ "      _ _____  _                      _", "     | |  __ \\| |                    | |", "   __| | |__) | |     __ _  ___ _   _| | __ _", "  / _` |  _  /| |    / _` |/ __| | | | |/ _` |", " | (_| | | \\ \\| |___| (_| | (__| |_| | | (_| |", "  \\__,_|_|  \\_\\______\\__,_|\\___|\\__,_|_|\\__,_|" ];
  var drawMenuTitle = function (x) {
      return function (y) {
          ...
          return Prelude["void"](Control_Monad_Eff.functorEff)(Data_Array.foldM(Control_Monad_Eff.monadEff)(drawer)(y)(asciiArtTitle));
      };
  };
  var drawMenu = function __do() {
  ...
  exports["asciiArtTitle"] = asciiArtTitle;
  exports["drawMenuTitle"] = drawMenuTitle;
